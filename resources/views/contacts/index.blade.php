                    ...
                    @forelse($contact as $contact)
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="submit" class="btn btn-danger" onclick="document.getElementById('delete-form-{{$contact->id}}').submit()">Supprimer</button>
                                <form action="{{route('contacts.destroy', $contact)}}" method="post" id="delete-form-{{$contact->id}}" style="display:none">
                                    @csrf
                                    @method('DELETE')
                                </form>
                            </td>
